...
- ヒーローをスタッフとして雇い（品出し・警備・行商など 11 職）、店に設備を置いて、手を離しても回る店へ
- 閉店後に、五勢力（朱雀・青龍・黄竜・白虎・玄武）＋店舗・研究の枝をもつスキルツリーで工房を強化
...
| 閉店後のスキルツリー | ノードを選んで習得（GUM・ゴールドダスト・研究ポイント）。ドラッグで移動、ホイールで拡大縮小。魔石の投入先もここで選ぶ |
