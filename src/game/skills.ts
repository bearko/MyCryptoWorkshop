...
const PHASE2_NODES: SkillNode[] = [
  ...
  { id: 'saleDust', branch: 'genbu', name: '金粉の還元', desc: '品が売れるたびに、そのレア度に応じたゴールドダストが手に入る（分解したときの 1%。精錬などのダスト増加も効く）', icon: icons.dust, x: -7, y: 0, max: 5, baseCost: 50000, growth: 3, requires: ['dustYield'], effects: [add('saleDust', 0.01)] },
