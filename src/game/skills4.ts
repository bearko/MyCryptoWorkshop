...
export const PHASE4_NODES: SkillNode[] = [
  ...
  node({ id: 'negotiation', branch: 'byakko', name: '値切り交渉', desc: '商人の買取価格 +4%（客に売る値段の）', icon: seriesIcon('Sensu', 2), x: -4, y: 4, max: 5, baseCost: 1500, growth: 1.8, requires: ['chestValue'], effects: [add('merchantRate', 0.04)] }),
  ...
  node({ id: 'collectorFocus', branch: 'seiryu', name: 'コレクター優先', desc: '店にいるコレクター客が探しているシリーズが、クラフトされやすくなる', icon: seriesIcon('Glasses', 3), x: 4, y: -2, max: 3, baseCost: 60000, growth: 1.9, requires: ['collectors'], effects: [add('collectorFocus', 1)] }),
