...
export const PHASE4_NODES: SkillNode[] = [
  ...
  node({ id: 'negotiation', branch: 'byakko', name: '値切り交渉', desc: '悪徳商人の買取価格 +4%（客に売る値段の）', icon: seriesIcon('Sensu', 2), x: -4, y: 4, max: 5, baseCost: 1500, growth: 1.8, requires: ['chestValue'], effects: [add('merchantRate', 0.04)] }),
