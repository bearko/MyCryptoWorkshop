import { customers, RARITIES, RARITY_JA, type Hero } from './catalog';
...
export const AFFINITY = [
  { visits: 5, name: '顔なじみ', pay: 0.05 },
  { visits: 20, name: '常連', pay: 0.1 },
  { visits: 50, name: '大ファン', pay: 0.2 },
];
